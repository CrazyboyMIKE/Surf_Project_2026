...
export const ALLOWED_COMMANDS = ["1000", "1002", "1003"] as const;

const MAX_DISTANCE_CM = 100;
const MAX_ROTATION_DEG = 180;
const MAX_SPEED = 600;
const ALLOWED_COMMANDS_MESSAGE = "Command must be one of 1000, 1002, or 1003";
...
export function validateRobotControlMessage(options: {
  ...
  if (!command) {
    return {
      ...
      message: ALLOWED_COMMANDS_MESSAGE
    };
  }
